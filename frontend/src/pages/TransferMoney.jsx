export default function TransferMoney() {
    return <div class="flex justify-center h-screen bg-gray-100">
        <div className="h-full flex flex-col justify-center">
            <div
                class="border border-transparent h-min text-card-foreground max-w-md p-4 space-y-8 w-96 bg-white shadow-lg rounded-lg">
                ...
                <div class="space-y-4">
                    ...
                    <input
                        type="number"
                        class="flex h-10 w-full rounded-md border border-transparent bg-background px-3 py-2 text-sm"
                        id="amount"
